				...
				<ul class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                            ...
                            <span class="side-menu__label">Categories</span><i class="angle fe fe-chevron-down"></i>
                        </a>
                        <ul class="slide-menu">
                                <li><a class="slide-item" href="{{ route('categories') }}">Categories List</a></li>
                                <li><a class="slide-item" href="{{ route('categories.trash') }}">Categories Trash List</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                            ...
                            <span class="side-menu__label">Movies</span><i class="angle fe fe-chevron-down"></i>
                        </a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ route('movies') }}">Movies List</a></li>
                            <li><a class="slide-item" href="{{ route('movies.trash') }}">Movies Trash List</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ route('users.trash') }}">Users Trash List</a></li>
                        </ul>
                    </li>
