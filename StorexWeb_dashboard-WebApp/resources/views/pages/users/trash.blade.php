...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Basic Data</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  Users Trash List</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
									...
									<table class="table text-md-nowrap table-hover table-striped" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-30p border-bottom-0 text-center">Name</th>
												<th class="wd-20p border-bottom-0 text-center">Email</th>
												<th class="wd-10P border-bottom-0 text-center">BirthDate</th>
										...
										<tbody class="">
                                            @forelse ($users as $user)
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">{{ $user->deleted_at }}</td>
                                                    <td class="text-center align-middle">

                                                            <a class="btn btn-success btn-sm" href="{{ route('users.restore',$user->id) }}" title="Restore"><i class="fas fa-trash-restore"></i></a>
